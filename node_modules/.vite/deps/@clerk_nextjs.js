...
import {
  ...
  useSignUp,
  useUser
} from "./chunk-I3VPT44A.js";
import {
  eventFrameworkMetadata
} from "./chunk-65WSYWCZ.js";
import {
  isTruthy
} from "./chunk-Y47XA3OG.js";
...
var require_router = __commonJS({
  "node_modules/next/dist/client/compat/router.js"(exports, module) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
var require_router2 = __commonJS({
  "node_modules/next/compat/router.js"(exports, module) {
...
var require_script2 = __commonJS({
  "node_modules/next/script.js"(exports, module) {
...
var require_remove_base_path = __commonJS({
  "node_modules/next/dist/client/remove-base-path.js"(exports, module) {
    ...
    Object.defineProperty(exports, "removeBasePath", {
      enumerable: true,
      get: function() {
        return removeBasePath2;
      }
    });
    var _hasbasepath = require_has_base_path();
    var basePath = process.env.__NEXT_ROUTER_BASEPATH || "";
    function removeBasePath2(path) {
...
var require_router4 = __commonJS({
  "node_modules/next/dist/client/router.js"(exports, module) {
    ...
    var _interop_require_default = require_interop_require_default();
    var _react = _interop_require_default._(require_react());
    var _router = _interop_require_default._(require_router3());
    var _routercontextsharedruntime = require_router_context_shared_runtime();
...
var require_router5 = __commonJS({
  "node_modules/next/router.js"(exports, module) {
    module.exports = require_router4();
  }
});
...
var PromisifiedAuthContext = import_react.default.createContext(null);
...
var usePagesRouter = () => {
  return { pagesRouter: (0, import_router2.useRouter)() };
};

// node_modules/@clerk/nextjs/dist/esm/client-boundary/hooks/useEnforceCatchAllRoute.js
var useEnforceCatchAllRoute = (component, path, routing, requireSessionBeforeCheck = true) => {
  const ref = import_react2.default.useRef(0);
...
var usePathnameWithoutCatchAll = () => {
  const pathRef = import_react3.default.useRef();
  const { pagesRouter } = usePagesRouter();
  if (pagesRouter) {
    if (pathRef.current) {
  ...
  const usePathname2 = require_navigation().usePathname;
...
var UserProfile2 = Object.assign(
  (props) => {
    return import_react4.default.createElement(UserProfile, { ...useEnforceCorrectRoutingProps("UserProfile", props) });
  },
  { ...UserProfile }
);
var OrganizationProfile2 = Object.assign(
  (props) => {
    return import_react4.default.createElement(OrganizationProfile, { ...useEnforceCorrectRoutingProps("OrganizationProfile", props) });
  },
  { ...OrganizationProfile }
);
var SignIn2 = (props) => {
  return import_react4.default.createElement(SignIn, { ...useEnforceCorrectRoutingProps("SignIn", props, false) });
};
var SignUp2 = (props) => {
  return import_react4.default.createElement(SignUp, { ...useEnforceCorrectRoutingProps("SignUp", props, false) });
};

// node_modules/@clerk/nextjs/dist/esm/client-boundary/ClerkProvider.js
var import_router4 = __toESM(require_router2());
...
var import_navigation4 = __toESM(require_navigation());
...
var ClerkNextOptionsCtx = import_react6.default.createContext(void 0);
ClerkNextOptionsCtx.displayName = "ClerkNextOptionsCtx";
var useClerkNextOptions = () => {
  const ctx = import_react6.default.useContext(ClerkNextOptionsCtx);
  return ctx == null ? void 0 : ctx.value;
};
var ClerkNextOptionsProvider = (props) => {
  const { children, options } = props;
  return import_react6.default.createElement(ClerkNextOptionsCtx.Provider, { value: { value: options } }, children);
};

// node_modules/@clerk/nextjs/dist/esm/utils/clerk-js-script.js
var import_script = __toESM(require_script2());
...
// node_modules/@clerk/nextjs/dist/esm/utils/router-telemetry.js
var RouterTelemetry = () => {
  var _a, _b;
...
var import_navigation2 = __toESM(require_navigation());
...
var useInternalNavFun = (props) => {
  ...
  return (0, import_react8.useCallback)((to, metadata) => {
...
var import_navigation3 = __toESM(require_navigation());
...
// node_modules/@clerk/nextjs/dist/esm/app-router/client/ClerkProvider.js
var LazyCreateKeylessApplication = (0, import_dynamic.default)(
  () => import("./keyless-creator-reader-VW3BNITY.js").then((m) => m.KeylessCreatorOrReader)
);
var NextClientClerkProvider = (props) => {
  if (isNextWithUnstableServerActions) {
    const deprecationWarning = `Clerk:
Your current Next.js version (${package_default.version}) will be deprecated in the next major release of "@clerk/nextjs". Please upgrade to next@14.1.0 or later.`;
    if (inBrowser()) {
...
`);
  ...
  const [isPending, startTransition] = (0, import_react9.useTransition)();
  useSafeLayoutEffect(() => {
    if (canUseKeyless) {
  ...
  return import_react9.default.createElement(ClerkNextOptionsProvider, { options: mergedProps }, import_react9.default.createElement(ClerkProvider, { ...mergedProps }, import_react9.default.createElement(RouterTelemetry, null), import_react9.default.createElement(ClerkJSScript, { router: "app" }), children));
};
var ClientClerkProvider = (props) => {
  ...
  if (safePublishableKey || !canUseKeyless || disableKeyless) {
    return import_react9.default.createElement(NextClientClerkProvider, { ...rest }, children);
  }
  return import_react9.default.createElement(LazyCreateKeylessApplication, null, import_react9.default.createElement(NextClientClerkProvider, { ...rest }, children));
};

// node_modules/@clerk/nextjs/dist/esm/pages/ClerkProvider.js
var import_router3 = __toESM(require_router5());
...
function ClerkProvider2({ children, ...props }) {
  ...
  const { push, replace } = (0, import_router3.useRouter)();
  ...
  return import_react10.default.createElement(ClerkNextOptionsProvider, { options: mergedProps }, import_react10.default.createElement(
    ClerkProvider,
    {
      ...mergedProps,
      initialState
    },
    import_react10.default.createElement(RouterTelemetry, null),
    import_react10.default.createElement(ClerkJSScript, { router: "pages" }),
    children
  ));
}

// node_modules/@clerk/nextjs/dist/esm/client-boundary/ClerkProvider.js
function ClerkProvider3(props) {
  const router = (0, import_router4.useRouter)();
  const Provider = router ? ClerkProvider2 : ClientClerkProvider;
  return import_react11.default.createElement(Provider, { ...props });
}

// node_modules/@clerk/nextjs/dist/esm/index.js
var ClerkProvider4 = ClerkProvider3;
var SignedIn2 = SignedIn;
var SignedOut2 = SignedOut;
var Protect2 = Protect;
export {
  APIKeys,
  AuthenticateWithRedirectCallback,
  ClerkDegraded,
  ...
  ClerkLoaded,
  ClerkLoading,
  ClerkProvider4 as ClerkProvider,
  CreateOrganization,
  GoogleOneTap,
  OrganizationList,
  ...
  SignUp2 as SignUp,
  SignUpButton,
  SignedIn2 as SignedIn,
  SignedOut2 as SignedOut,
  TaskChooseOrganization,
  UserButton,
...
next/dist/compiled/react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=@clerk_nextjs.js.map
